minefields()
{
	...
	{
		if(level.ex_minefields == 1) level._effect["mine_explosion"] = [[level.ex_PrecacheEffect]]("fx/explosions/grenadeExp_dirt.efx");
			else if(level.ex_minefields == 2) level._effect["mine_explosion"] = [[level.ex_PrecacheEffect]]("fx/smoke/orange_smoke_20sec.efx");
				else if(level.ex_minefields == 3) level._effect["mine_explosion"] = [[level.ex_PrecacheEffect]]("fx/extreme_napalm/napalm.efx");
	}

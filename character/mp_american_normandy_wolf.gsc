...
main()
{
	...
	self attach("xmodel/head_us_ranger_wolf", "", true);
...
precache()
{
	[[level.ex_PrecacheModel]]("xmodel/playerbody_american_normandy08");
	[[level.ex_PrecacheModel]]("xmodel/head_us_ranger_wolf");
